...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model: int, dropout: float = 0.1, max_len: int = 300, device: str = None):
        super().__init__()
...
if __name__ == "__main__":
    ...
    model = TestTransf(d_model=7, nhead=7, d_hid=1048, nlayers=6, dropout=0.5, target_length=96, device=device)
